...
export const TOURS: Tour[] = [
  ...
  },
  {
    ...
    inclusions: ["Return flights", "4★ Old City hotel", "Flame Towers tour", "Mud Volcanoes excursion", "Daily breakfast"],
    pricePKR: 220000,
    seatsLeft: 8,
    totalSeats: 20,
    rating: 4.8,
    reviews: 94,
    summary:
      "Explore the futuristic Flame Towers, historic Icherisheher Old City, Yanar Dag (Fire Mountain), and Gobustan Rock Art.",
    itinerary: [
      { day: 1, title: "Karachi → Baku", detail: "Arrival, Nizami street walking tour." },
      { day: 2, title: "Old & New Baku", detail: "Icherisheher, Maiden Tower, Flame Towers." },
      { day: 3, title: "Fire Temple & Mountain", detail: "Ateshgah Fire Temple and Yanar Dag." },
      { day: 4, title: "Gobustan & Mud Volcanoes", detail: "Rock art petroglyphs and bubbling mud volcanoes." },
      { day: 5, title: "Fly home", detail: "Baku Heydar Aliyev → Karachi." },
    ],
  },
  {
    id: "hunza-skardu-8d",
    ...
    inclusions: ["Prado/Coaster VIP transport", "Shangrila & Serena stays", "Attabad boating", "Professional guide", "Daily meals"],
    pricePKR: 145000,
    seatsLeft: 10,
    totalSeats: 25,
    rating: 4.9,
    reviews: 280,
    summary:
      "Boating on turquoise Attabad Lake, sunset at Eagle's Nest, Shangrila Resort in Skardu, Upper Kachura Lake, and Deosai Plains.",
    itinerary: [
      { day: 1, title: "ISB → Chilas / Naran", detail: "Scenic drive via Babusar Pass / KKH." },
      { day: 2, title: "Reach Karimabad", detail: "Rakaposhi viewpoint, Altit Fort evening." },
      { day: 3, title: "Hunza & Attabad", detail: "Baltit Fort, Attabad lake boating, Passu Cones." },
      { day: 4, title: "Drive to Skardu", detail: "Astor gorge drive, check in Skardu." },
      { day: 5, title: "Shangrila & Upper Kachura", detail: "Heart-shaped Shangrila lake and trout boating." },
      { day: 6, title: "Deosai National Park", detail: "Land of Giants, Sheosar Lake." },
      { day: 7, title: "Return to Besham", detail: "Scenic drive along Indus river." },
      { day: 8, title: "Besham → Islamabad", detail: "Return transfer to Islamabad." },
    ],
  },
  {
    ...
    inclusions: ["Return flights", "Clock Tower 4★ Makkah", "Prophet Mosque 4★ Madinah", "Umrah Visa", "VIP Haramain Train"],
    pricePKR: 320000,
    seatsLeft: 12,
    totalSeats: 30,
    rating: 5.0,
    reviews: 412,
    summary:
      "7 nights in Makkah with Clock Tower walking distance, 7 nights in Madinah near Markaziya, complete Ziyarat with guidance.",
    itinerary: [
      { day: 1, title: "Lahore → Jeddah → Makkah", detail: "Arrival, private transfer to hotel, perform Umrah." },
      { day: 2, title: "Makkah Haram", detail: "Prayers in Masjid al-Haram." },
      { day: 3, title: "Makkah Ziyarat", detail: "Jabal al-Noor (Hira), Mina, Muzdalifah, Arafat." },
      { day: 8, title: "Haramain Train to Madinah", detail: "High-speed train transfer to Madinah hotel." },
      { day: 9, title: "Madinah Ziyarat", detail: "Masjid Quba, Mount Uhud, Masjid al-Qiblatayn." },
      { day: 15, title: "Madinah → Lahore", detail: "Fly direct Madinah Prince Mohammad Airport → Lahore." },
    ],
  },
];
